    ...
    public abstract class DbContext
    {
        ...
        public void SaveChanges()
        {
            var dbSets = this.dbSetProperties
                            .Select(prop => prop.Value.GetValue(this))
                            .ToArray();
        ...
        private void MapAllRelations()
        {
            foreach (var dbSetProperty in this.dbSetProperties)
            {
                ...
                mapAllRelationsGeneric.Invoke(this, new[] { dbSet });
            }
        }
            ...
            where TCollection : class, new()
        {
            ...
            var primaryKeys = collectionType.GetProperties()
                                .Where(prop => prop.HasAttribute<KeyAttribute>())
                                .ToArray();
            ...
            if (isManyToMany)
            {
                primaryKey = collectionType.GetProperties()
                                .First(prop => collectionType
                                                .GetProperty(prop.GetCustomAttribute<ForeignKeyAttribute>().Name)
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var columns = table.GetProperties()
                            .Where(prop => dbColumns.Contains(prop.Name)
                                        && !prop.HasAttribute<NotMappedAttribute>()
                                        && AllowedSqlTypes.Contains(prop.PropertyType))
